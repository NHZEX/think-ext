...
namespace Zxin\Think\Ext\Model;
...
trait ModelAttrObjectCacheTrait
{
     ...
     * @throws Exception
     */
    protected function attrObjectCacheSet(string $funcname, $value, $classname, bool $transformJson = false)
    {
        $key = substr($funcname, 3);
